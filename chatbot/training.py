import nltk, random, json , pickle, json, os
...
#Class training wil read the intents file and process the data
...
class Training:
    def __init__(self):
        ...
        self.ignore_words=list("!@#$%^&*?") #this contains the symbols which we want to remove from the patterns
        self.process_data()
